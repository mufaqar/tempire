          ...
          <div className="md:pr-10 ">
            ...
            <div className="md:w-[80%] w-full">
              <p className="text-sm font-medium leading-[2] tracking-wide text-[#333333] mb-10">
                Tempire is a Professional Mover Platform. Here we will provide
                you only interesting content, which you will like very much.
                We're dedicated to providing you the best of Mover, with a focus
                on dependability and shipping. We're working to turn our passion
                for Mover into a booming online website. We hope you enjoy our
                Mover as much as we enjoy offering them to you.
              </p>
              <p className="text-sm font-medium leading-[2] tracking-wide text-[#333333] mb-10">
                Class aptent taciti sociosqu ad litora torquent per conubia
                nostra, per inceptos himenaeos. Aenean pellentesque tempor
                libero eget rhoncus.
              </p>
            </div>
          </div>
