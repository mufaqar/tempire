    ...
    <>
        ...
        <div className="h-full w-full bg-white/70 flex">
          <div className="container mx-auto px-4 py-10 grid grid-cols-1 md:grid-cols-2 justify-center items-center z-10 gap-8 md:gap-12">
            <div className="max-w-[520px] w-full order-2 md:order-none mb-10 md:mb-0">
              <h6 className="text-[#edc05f] uppercase font-semibold text-sm bg-gray-800 p-1 inline-block px-2">
              ...
              <Link
                ...
                className=" px-9 py-3  bg-[#edc05f] hover:text-white hover:bg-gray-900  uppercase font-sans text-sm font-medium shadow-md rounded-full"
              >
                APPLY NOW
              </Link>
            </div>
      ...
      <section className="container mx-auto px-4 my-10 md:flex items-center justify-between">
        <div className="md:w-[70%]">
          <h6 className="text-[#edc05f] uppercase font-semibold text-sm">
            Equipment Financing
          </h6>
        ...
        <div className="md:w-[30%] w-full md:flex justify-end">
          <Link
            href="https://www.goamur.com/partner-landing/tempire/"
            className=" px-16 py-5 md:w-full md:p-7 text-center bg-[#edc05f] hover:text-white hover:bg-gray-900  uppercase text-xl font-sans font-medium rounded-full"
          >
            APPLY NOW
          </Link>
        </div>
